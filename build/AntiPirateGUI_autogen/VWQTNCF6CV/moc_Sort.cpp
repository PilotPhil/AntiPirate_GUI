...
QT_MOC_LITERAL(1, 5, 12), // "SendTrackRes"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 19), // "vector<TrackingBox>"
QT_MOC_LITERAL(4, 39, 19) // "frameTrackingResult"

    },
    "Sort\0SendTrackRes\0\0vector<TrackingBox>\0"
    "frameTrackingResult"
};
...
void Sort::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->SendTrackRes((*reinterpret_cast< const vector<TrackingBox>(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Sort::*)(const vector<TrackingBox> );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Sort::SendTrackRes)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Sort::SendTrackRes(const vector<TrackingBox> _t1)
{
